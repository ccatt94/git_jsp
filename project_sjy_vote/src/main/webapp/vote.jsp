				...
				<div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar"
					...
					<div class="offcanvas-body">
						<ul id="navbar"
							...
							<li class="nav-item"><a class="nav-link me-4 link-dark"
								href="vote.do" role="button">투표하기</a></li>
							<li class="nav-item"><a class="nav-link me-4 link-dark"
								href="voteList.do" role="button">투표검수조회</a></li>
							<li class="nav-item"><a class="nav-link me-4 link-dark"
								href="memberRank.do" role="button">후보자등수</a></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<section class="voteSection">
			...
			<table class="votetable">
				<tbody align="center" >
					<tr>
						...
						<td><input type="text" id="v_jumin" name="v_jumin"
							placeholder="예시) 9408282012341"></td>
					</tr>

					<tr>
						<td scope="col">성명</td>
						<td scope="col"><input type="text" id="v_name" name="v_name"></td>
					</tr>
					...
					<tr>
						<td scope="col">투표시간</td>
						<td><select id="v_time" name=v_time>
					...
					<tr>
						<td scope="col">투표장소</td>
						<td scope="col"><select id="v_area" name=v_area>
		...
		<div
			...
			<div class="col-lg-8 align-self-baseline">
				<input type="submit" value="투표하기" class="btn btn-primary btn-lg"> 
				<input type="reset" value="다시하기" class="btn btn-primary btn-lg">
			</div>
		</div>
		</div>
