	...
	<h1>투표지</h1>
		...
		<form action="vote_ok.do" method="post" onsubmit="handleSubmit(event)">
         ...
         <tr>
            ...
            <td> &nbsp; <input type="text" name="v_jumin"> &nbsp; ex) 9408282012341</td>
         </tr>
         ...
         <tr>
            ...
            <td> <input required type="text" name="v_time"></td>
         </tr>
         ...
         <tr>
            ...
            <td> <input type="radio" id="check" value="Y" name="v_confirm">확인  &nbsp; &nbsp; <input type="radio" value="N" id="non-check" name="v_confirm">미확인</td>
            
         </tr>
         
         <tr>
            <td colspan="2" align="center"> <button type="submit">투표하기</button> &nbsp;&nbsp; <button type="reset"> 다시하기</button>&nbsp;&nbsp;  &nbsp;</td>
