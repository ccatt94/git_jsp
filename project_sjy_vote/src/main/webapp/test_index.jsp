...
<body data-bs-spy="scroll" data-bs-target="#navbar"
	...
	<header id="header"
		...
		<nav id="header-nav" class="navbar navbar-expand-lg px-3">
			<div class="container-fluid">
				<a class="navbar-project h1 p-2" href="test_index.jsp"> Five
					Coding </a>
              ...
              <use xlink:href="#navbar-icon"></use>
				...
				<div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar"
					...
					<div class="offcanvas-header px-4 pb-0">
						<h1 class="display-1 text-uppercase text-dark pb-5">Five
							Coding</h1>
					...
					<div class="offcanvas-body">
						<ul id="navbar"
							...
							<li class="nav-item"><a class="nav-link me-4 active"
								href="test_index.jsp">Home</a>
							<li class="nav-item dropdown"><a
								class="nav-link me-4 dropdown-toggle link-dark"
								data-bs-toggle="dropdown" href="#" role="button"
								aria-expanded="false">투표</a>
								<ul class="dropdown-menu">
									<li><a href="index.do" class="dropdown-item">투표메인</a></li>
									<li><a href="member.do" class="dropdown-item">후보조회</a></li>
									<li><a href="vote.do" class="dropdown-item">투표하기</a></li>
									<li><a href="voteList.do" class="dropdown-item">투표검수조회</a>
									</li>
									<li><a href="memberRank.do" class="dropdown-item">후보자등수</a>
									</li>
								</ul></li>
							<li class="nav-item dropdown"><a
								class="nav-link me-4 dropdown-toggle link-dark"
	...
	<section id="each-project"
		class="product-store position-relative padding-large no-padding-top">
		<div class="container">
			<div class="row">
				<div
					class="display-header d-flex flex-wrap justify-content-between mt-5 pb-5">
				</div>
			</div>
			<div class="row mt-5">
				<div class="d-flex justify-content-between pe-2">
					<div class="product-card position-relative pe-2">
						<div class="image-holder">
							<img src="resource/images/vote-1-s.jpg" alt="product-item"
								class="img-fluid">
						</div>
					...
					<div class="product-card position-relative pe-2">
						<div class="image-holder">
							<img src="resource/images/product-item2.jpg" alt="product-item"
								class="img-fluid">
						</div>
						<div class="cart-concern position-absolute">
							<div class="cart-button d-flex">
					...
					<div class="product-card position-relative pe-2">
						<div class="image-holder">
							<img src="resource/images/product-item3.jpg" alt="product-item"
								class="img-fluid">
						</div>
						<div class="cart-concern position-absolute">
							<div class="cart-button d-flex">
					...
					<div class="product-card position-relative pe-2">
						<div class="image-holder">
							<img src="resource/images/product-item4.jpg" alt="product-item"
								class="img-fluid">
						</div>
						<div class="cart-concern position-absolute">
							<div class="cart-button d-flex">
					...
					<div class="product-card position-relative pe-2">
						<div class="image-holder">
							<img src="resource/images/product-item5.jpg" alt="product-item"
								class="img-fluid">
						</div>
						<div class="cart-concern position-absolute">
							<div class="cart-button d-flex">
	...
	<hr>
		<div class="row d-flex flex-wrap justify-content-between">
			<p class="copyright" align="center">
				Copyright 2024. Tomsboy Project Five Coding all rights reserved
			</p>
		</div>
	</footer>
